...
export default function Home() {
  ...
  const [messageState, setMessageState] = useState<{
    ...
    messages: [
      {
        message: 'Hi. What would you like to learn about Berkshire Hathaway&apos;s annual reports?',
        type: 'apiMessage',
      },
    ],
    history: [],
    ...
    <>
      <Layout>
        ...
        <h1 className={styles.slogan}>
            <span className={styles.sloganAskEDGAR}>AskEDGAR</span> about Berkshire Hathaway&apos;s 10-K Filings
          </h1>
          <div className={styles.currentFileWrapper}>
           <div className={styles.currentFileText}>
              Current Data Source:<span className={styles.currentFileName}> Berkshire Hathaway 10-Ks 2020-2022</span>
             </div>
           </div>
